...
public class UserInterface implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == menuItem3) {
            // Generate a random hue value within the orange range
            float randomHue = random.nextFloat() * 30 + 15;
            // Convert to HSB color
            Color randomOrangeColor = Color.getHSBColor(randomHue / 360, 1, 1);
            // Change the frame's content pane color to the random orange hue
            frame.getContentPane().setBackground(randomOrangeColor);
        }
